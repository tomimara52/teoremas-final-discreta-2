...
\label{sec:orgf738701}
\subsection{Definiciones}
\label{sec:org7ece5aa}
Primero, recuerdo las definiciones. Para un flujo f y vértices x,z:
\begin{align*}
d_f(x, z) =
  \begin{cases}
    0 \quad\text{si } x = z \\
    \infty \quad\text{si no existe f-camino aumentante entre x y z} \\
