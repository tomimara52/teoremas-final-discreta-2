...
\label{sec:org51c8105}
Para esta demostración usaré las definiciones y resultados de \hyperref[sec:orgc300831]{\uline{este teorema}}.
...
\label{sec:orgc300831}
\subsection{Definiciones}
\label{sec:orgd9d2d7b}
...
\label{sec:org9ad761b}
Para ello probaré que 3SAT \(\le\) 3COLOR.

\subsection{Algoritmo}
\label{sec:org9a7e9eb}
...
\label{sec:org0e8bc4e}
\[\{(CAPI)e_{jr}\}_\substack{j=1,\cdots,m & r=1,2,3} \]

\item \underline{Lados}
\label{sec:org098436a}
\[ \{(CAPI)t\}\]

\item \underline{Lados}
\label{sec:org9255921}
...
\label{sec:org9085121}
\subsubsection*{\underline{\(\impliedby\) vuelta}}
\label{sec:orgf2836d7}
...
\label{sec:org8036395}
\subsubsection*{\underline{\(\implies\) ida}}
\label{sec:org439b466}
