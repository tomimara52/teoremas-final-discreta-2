...
\label{sec:org9b4ae42}
Para esta demostración usaré las definiciones y resultados de \hyperref[sec:org6e94a71]{\uline{este teorema}}.
...
\label{sec:org6e94a71}
\subsection*{Definiciones}
\label{sec:org05a6cba}
...
\label{sec:org2c87e79}
Para ello probaré que 3SAT \(\le\) 3COLOR.

\subsection*{Algoritmo}
\label{sec:org12c6ece}
...
\label{sec:org964808f}
\[\{(CAPI)e_{jr}\}_\substack{j=1,\cdots,m & r=1,2,3} \]

\item \underline{Lados}
\label{sec:orgaf090c4}
\[ \{(CAPI)t\}\]

\item \underline{Lados}
\label{sec:org0fe2d32}
...
\label{sec:org57a92bd}
\subsubsection*{\underline{\(\impliedby\) vuelta}}
\label{sec:org3de49d6}
...
\label{sec:org2af225c}
\subsubsection*{\underline{\(\implies\) ida}}
\label{sec:orga8dc586}
