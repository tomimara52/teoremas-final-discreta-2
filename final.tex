...
\label{sec:org464e4f4}
Para esta demostración usaré las definiciones y resultados de \hyperref[sec:org6f3b9a8]{\uline{este teorema}}.
...
\label{sec:org6f3b9a8}
\subsection{Definiciones}
\label{sec:org7e65c10}
...
\label{sec:org0fa2f16}
Para ello probaré que 3SAT \(\le\) 3COLOR.

\subsection{Algoritmo}
\label{sec:org2599779}
...
\label{sec:orgf70786e}
\[\{(CAPI)e_{jr}\}_\substack{j=1,\cdots,m & r=1,2,3} \]

\item \underline{Lados}
\label{sec:orgc0c54cd}
\[ \{(CAPI)t\}\]

\item \underline{Lados}
\label{sec:orgc26b5eb}
...
\label{sec:org63117bb}
\subsubsection*{\underline{\(\impliedby\) vuelta}}
\label{sec:org06f5758}
