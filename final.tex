...
\label{sec:orgc4fb191}
Para esta demostración usaré las definiciones y resultados de \hyperref[sec:org267ea94]{\uline{este teorema}}.
...
\label{sec:org267ea94}
\subsection{Definiciones}
\label{sec:org79c4c47}
...
\label{sec:org8452d40}
Para ello probaré que 3SAT \(\le\) 3COLOR.

\subsection{Algoritmo}
\label{sec:orgbeda716}
...
\label{sec:org79213f6}
\[\{(CAPI)e_{jr}\}_\substack{j=1,\cdots,m & r=1,2,3} \]

\item \underline{Lados}
\label{sec:org9e38aaf}
\[ \{(CAPI)t\}\]

\item \underline{Lados}
\label{sec:org5a517d9}
...
\label{sec:org7a2d3ba}
\subsubsection*{\underline{\(\impliedby\) vuelta}}
\label{sec:org980ba02}
