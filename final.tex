...
\label{sec:org19d7c3f}
Para esta demostración usaré las definiciones y resultados de \hyperref[sec:orgf4271d8]{\uline{este teorema}}.
...
\label{sec:orgf4271d8}
\subsection*{Definiciones}
\label{sec:orga688684}
...
\label{sec:org3a55e2b}
Para ello probaré que 3SAT \(\le\) 3COLOR.

\subsection*{Algoritmo}
\label{sec:org60b3c2c}
...
\label{sec:org4cdd4b0}
\[\{(CAPI)e_{jr}\}_\substack{j=1,\cdots,m & r=1,2,3} \]

\item \underline{Lados}
\label{sec:orgdbcc3ec}
\[ \{(CAPI)t\}\]

\item \underline{Lados}
\label{sec:orgce32792}
...
\label{sec:org45af6f8}
\subsubsection*{\underline{\(\impliedby\) vuelta}}
\label{sec:orgd1966de}
...
\label{sec:org5f67154}
\subsubsection*{\underline{\(\implies\) ida}}
\label{sec:org5c4e131}
