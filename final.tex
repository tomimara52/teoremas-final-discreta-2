...
\label{sec:orgabe4385}
Para esta demostración usaré las definiciones y resultados de \hyperref[sec:org00f8b40]{\uline{este teorema}}.
...
\label{sec:org00f8b40}
\subsection{Definiciones}
\label{sec:org34bf5d0}
...
\label{sec:org5f79f08}
Para ello probaré que 3SAT \(\le\) 3COLOR.

\subsection{Algoritmo}
\label{sec:org6d8ec60}
...
\label{sec:orgac41ad5}
\[\{(CAPI)e_{jr}\}_\substack{j=1,\cdots,m & r=1,2,3} \]

\item \underline{Lados}
\label{sec:orgd10ba54}
\[ \{(CAPI)t\}\]

\item \underline{Lados}
\label{sec:orgc4186a9}
...
\label{sec:orgbbac065}
\subsubsection*{\underline{\(\impliedby\) vuelta}}
\label{sec:orga83879b}
