...
\label{sec:org2779313}
Para esta demostración usaré las definiciones y resultados de \hyperref[sec:org5165792]{\uline{este teorema}}.
...
\label{sec:org5165792}
\subsection{Definiciones}
\label{sec:org0da62ab}
...
\begin{align*}
	E_j(\overrightarrow{b}, \overrightarrow{d}) & = (l_{j1} \lor l_{j2} \lor y_{j1})(\overrightarrow{b}, \overrightarrow{d}) \quad("=1" \text{ pues } d_1 = 1)\\
      ...
      & \land (\overline{y_{j(k-1)}} \lor y_{jk} \lor l_{j(k+1)})(\overrightarrow{b}, \overrightarrow{d}) \quad("=1" \text{ pues } d_{j(k-1)} = 0) \\
      & \land \cdots \\
      & \land (\overline{y_{j(r_j-3)}} \lor l_{j(r_j-1)} \lor l_{jr_j})(\overrightarrow{b}, \overrightarrow{d}) \quad("=1" \text{ pues } d_{j(r_j-3)} = 0) \\
      & = 1
\end{align*}


\subsubsection*{\underline{\(\impliedby\) vuelta}}
\label{sec:orgefe8110}
