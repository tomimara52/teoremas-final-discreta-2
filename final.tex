...
\label{sec:org3df5e34}
Para esta demostración usaré las definiciones y resultados de \hyperref[sec:orgbc588d0]{\uline{este teorema}}.
...
\label{sec:orgbc588d0}
\subsection*{Definiciones}
\label{sec:orgee764a3}
...
\label{sec:orgf36b324}
Para ello probaré que 3SAT \(\le\) 3COLOR.

\subsection*{Algoritmo}
\label{sec:org23393ed}
...
\label{sec:orgf9ebf5c}
\[\{(CAPI)e_{jr}\}_\substack{j=1,\cdots,m & r=1,2,3} \]

\item \underline{Lados}
\label{sec:org335074f}
\[ \{(CAPI)t\}\]

\item \underline{Lados}
\label{sec:orgfba97e6}
...
\label{sec:orgc553287}
\subsubsection*{\underline{\(\impliedby\) vuelta}}
\label{sec:orgf2ed0bb}
...
\label{sec:orgce44e17}
\subsubsection*{\underline{\(\implies\) ida}}
\label{sec:org9385749}
